...
<section  className=" flex justify-between w-full sm:flex-col sm:justify-center sm:items-center">
    ...
    <div  data-aos="fade-right"  data-aos-duration="1500" className=" mt-[100px] w-[60%] sm:w-full sm:text-center sm:mt-8">
        ...
        <h3 className=" text-3xl text-[#006315]  font-semibold lg:text-2xl md:text-xl sm:text-base">Hello I am</h3>

        <h2 className="text-6xl font-bold my-6  lg:text-5xl md:text-4xl sm:text-xl sm:my-3">MOHAMMED HASSAN</h2>

        <h3 className=" text-3xl text-[#006315]  font-semibold  lg:text-2xl md:text-xl sm:text-base">Frontend Web Developer</h3>

        <p className="mt-10 mb-14 text-3xl font-medium  lg:text-2xl md:text-xl sm:text-base">I'm a passionate frontend web developer with a keen eye for detail and a love for creating seamless user experiences.</p>
