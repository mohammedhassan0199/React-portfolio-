...
<div  data-aos="fade-right"  data-aos-duration="1500" className="w-2/5 h-[85vh] object-cover flex justify-start sm:w-1/2 sm:h-[60vh] ">
    <img className="" src="about.webp" alt="" />
    {/* <Demo url="about.webp"/> */}
</div>
...
<div   data-aos="fade-left"  data-aos-duration="1500" className="w-3/5  sm:w-full sm:justify-center sm:flex sm:flex-col sm:items-center">
    <h2 className="text-6xl font-bold my-6  lg:text-5xl md:text-4xl sm:text-2xl sm:my-3">About Me</h2>
    <p className="mt-10 mb-14 text-3xl font-medium text-justify lg:text-2xl md:text-xl sm:text-base sm:mb-8">Hello! My name is Mohammed Hassan, and I am a frontend web developer with a fresh  BCA degree. My journey in web development began with a curiosity about how websites work and a passion for creating visually appealing and   functional designs. Over the past few years, I have immersed myself in learning and building projects that enhance my skills .</p>
    <div>
